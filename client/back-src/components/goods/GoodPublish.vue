<template>
  <div class="outter">
    <el-container>
      <el-header style="font-weight: bold;font-size: xx-large;">发布商品</el-header>
      <el-main>
        <el-form :model="form" label-width="120px">
          ...
          <el-row :gutter="0">
            <el-form-item label="商品价格" prop="">
              <el-input v-model="form.price" :on-input="form.price = inputNumPoint(form.price)"></el-input>
            </el-form-item>
          </el-row>
          <el-row :gutter="0">
            <el-form-item label="商品库存" prop="">
              <el-input v-model="form.stock" :on-input="form.stock = inputNum(form.stock)"></el-input>
            </el-form-item>
          </el-row>
        </el-form>
